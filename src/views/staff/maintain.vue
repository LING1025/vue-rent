    ...
    <el-container>
        ...
        <el-row>
          ...
          <el-col :span="4">
            <el-select v-model="listQuery.orgName" placeholder="部门" class="filter-item" style="width: 100%">
              <el-option v-for="item in orgOptions" :key="item.key" :label="item.display_name" :value="item.key" />
            </el-select>
          </el-col>
          <el-col :span="6">
      ...
      <el-main>
        <el-table v-loading="listLoading" :data="list" stripe border fit min style="width: 100%">
          ...
          <el-table-column align="center" label="职级" prop="titleName" />
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
          <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
            ...
            <el-form-item label="级别" prop="titleName">
              <el-select v-model="temp.titleName" placeholder="请选择级别" style="width: 100%;">
            ...
            <el-form-item label="角色" prop="role">
              <el-checkbox v-for="item in roleOptions" :key="item.key" v-model="item.checked" clearable :label="item.display_name" :value="item.key">
                {{ item.display_name }}
              </el-checkbox>
            </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        titleName: [{ required: true, message: '职级必选', trigger: 'change' }],
